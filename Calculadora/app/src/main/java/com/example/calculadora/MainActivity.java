...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_multiplicacion = findViewById(R.id.button_multipicacion);
  ...
  // llamaamos las variables y creando la funcion de diferentes operaciones
